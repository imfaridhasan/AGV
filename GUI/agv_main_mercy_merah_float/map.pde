void loadmap() {
  ...
  if (i>0) {
    ...
    fill(0, 0, 0, 90);
    //text("100m", 195, 495);
    text((int)jarakpertama+" m", 1205, 285);
    textAlign(LEFT);
  }
  popMatrix();
  if(i==0){
